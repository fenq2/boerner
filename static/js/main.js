...
$('.colors-catalog__list li').click(function() {
    var tabName = $(this).attr('show-tab');
    $(this).addClass('colors-catalog__item--active').siblings().removeClass('colors-catalog__item--active');
    $(this).closest('.item-catalog__nav').find('.item-catalog__slider .' + tabName).addClass('slider-prev--active').siblings().removeClass('slider-prev--active');
});
